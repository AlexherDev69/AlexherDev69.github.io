...
export const projects: Project[] = [
  ...
  },
  {
    ...
    solution: "EasyDiet fait tout le travail sur le téléphone. À partir d'un profil (poids, taille, objectif, activité), l'application calcule les besoins caloriques et compose le programme de repas, la liste de courses et le suivi de la progression. Aucun compte, aucun serveur, aucune donnée qui quitte l'appareil.",
    features: [
      "Plan de repas de la semaine selon le régime et 11 allergies gérées, avec contrôle des macros et jusqu'à trois jours libres.",
      'Plus de 200 recettes, chacune avec sa photo, avec instructions pas à pas et mode cuisson guidé avec minuteurs.',
      'Idée rapide : une envie (apéro, one pot, repas sympa, express) donne une recette adaptée au régime et aux allergies. Recherche de recettes par nom.',
    ...
    challenges: [
      { title: 'Génération sous contraintes', text: `Un moteur sélectionne les recettes en respectant la cible calorique à 10${NBSP}% près, le régime, les allergènes et les exclusions, avec une variété réglable (nombre de recettes différentes par repas) et un mode économique qui partage les ingrédients.` },
      { title: 'Agrégation des courses', text: "Une centaine de règles de synonymes d'ingrédients, conversion d'unités (densités, poids par pièce) et fusion en une seule ligne par ingrédient." },
      { title: 'Architecture hors ligne', text: "Clean Architecture, base Drift à 11 tables migrée jusqu'au schéma v14 sans perte de données, dates stockées en UTC pour résister aux changements de fuseau, injection GetIt et état géré avec Cubit. Aucun serveur : toutes les données restent sur l'appareil." },
      { title: 'Optimiseur de batch cooking', text: 'Développé, en préparation pour une prochaine version : entrelacement des étapes de préparation, cuisson et finition de plusieurs recettes pour cuisiner plusieurs jours en une session.' },
    ],
    result: `Publiée sur Google Play, adoptée par plus de 1${NBSP}500 utilisateurs et premier résultat sur Google Play en France pour «${NBSP}régime facile${NBSP}». Une application complète, portée d'une app Kotlin native vers Flutter et fiabilisée par plus de 700 tests automatisés et une CI GitHub Actions (analyse, tests, build) : une logique métier nutrition non triviale, 100${NBSP}% hors ligne et respectueuse de la vie privée.`,
    stack: ['Flutter', 'Dart', 'Cubit', 'Drift (SQLite)', 'GetIt', 'go_router', 'freezed', 'fl_chart', 'Clean Architecture', 'GitHub Actions'],
