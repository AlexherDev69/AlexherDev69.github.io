...
export type ShotFrame = 'phone' | 'tile';
...
export type ProjectGallery =
  | { kind: 'images'; frame: GalleryFrame; images: ProjectImage[] }
  | { kind: 'easydiet' }
  | { kind: 'crisis' };
...
export const projects: Project[] = [
  {
    ...
    features: [
      'Boucle de 1,5 à 16 km calibrée sur les pas restants, régénérable, avec départ GPS ou choisi sur la carte.',
    ...
    result: "Lancée sur Google Play en août 2026 et adoptée par plus de 500 utilisateurs. Un produit mené seul de l'idée à la publication, avec des workflows d'IA agentique (Claude Code).",
  ...
  },
  {
    slug: '5-minutes',
    title: '5 minutes',
    kicker: 'Projet personnel · SaaS B2B avec IA',
    tint: '#E7E1D6',
    tagline: "Mettre un salarié face à une crise simulée par l'IA, et mesurer son sang-froid en cinq minutes.",
    highlights: [
      { label: 'Modèle', value: 'SaaS B2B multi-entreprises' },
      { label: 'Évaluation', value: 'Sur 100 points' },
      { label: 'IA', value: 'RAG souverain, Mistral' },
    ],
    stackSummary: ['React', 'Node.js', 'Python', 'FastAPI', 'LangChain', 'Qdrant', 'Docker'],
    meta: [
      { label: 'Contexte', value: 'Projet personnel' },
    ...
    solution: "Un salarié est plongé dans une crise simulée. L'IA joue le scénario, s'adapte à chaque décision, mesure le temps de réaction et note la performance sur 100 points. À la sortie, un débrief actionnable.",
    features: [
      'Cadrage : secteur et type de crise (sanitaire, cyber, RH, réputation, environnement).',
      "Scénario généré par l'IA et ancré dans des cas réels grâce au RAG.",
      'Huit à dix tours sous pression, réponses chronométrées, crise qui évolue selon les décisions.',
      'Débrief complet : scores par critère et rapport PDF.',
    ],
    challenges: [
      { title: 'RAG souverain', text: "L'IA cite les procédures internes avec la source et la page. Recherche hybride dense et lexicale, hébergement en Europe, conforme RGPD." },
      { title: 'Multi-entreprises', text: 'Isolation par entreprise, espaces équipe, rôles administrateur et statistiques agrégées.' },
      { title: 'Dictée vocale', text: "Réponses orales transcrites en temps réel avec Voxtral, au plus près d'une vraie cellule de crise." },
      { title: 'Industrialisation', text: 'Monorepo Turborepo, conteneurs Docker, CI/CD GitHub Actions et déploiement sur VPS.' },
    ],
    result: 'Chaque simulation se conclut par une note sur 100 points (pertinence 35, communication 25, réactivité 20, procédures 20) et un rapport PDF actionnable.',
    stack: ['React', 'TypeScript', 'Node.js', 'Express', 'MongoDB', 'Stripe', 'Python', 'FastAPI', 'LangChain', 'Qdrant', 'Mistral', 'Voxtral', 'Turborepo', 'Docker'],
    links: [],
    stage: { kind: 'crisis' },
    gallery: { kind: 'crisis' },
  },
